...
export default function Sidebar({ onNewTask }) {
  const { tasks, workspaces, currentWorkspace, setCurrentWorkspace, createTeamWorkspace } = useApp();
    ...
    <aside className="sidebar">
            ...
            <span
              ...
              style={{
                fontVariationSettings: `'FILL' ${
                  /* filled when active is handled via CSS */
                  0
                }`,
              }}
            >
      ...
      <div className="sidebar-footer">
        {(!currentWorkspace || currentWorkspace.is_personal) && (
          <>
            <button className="sidebar-footer-link" onClick={handleCreateTeam} style={{ color: 'var(--primary)', marginBottom: 8 }}>
              <span className="material-symbols-outlined" style={{ fontSize: 20 }}>add_circle</span>
              Create Team Workspace
            </button>
            <button className="sidebar-footer-link" onClick={handleJoinTeam} style={{ color: 'var(--primary)', marginBottom: 8 }}>
        ...
        {currentWorkspace && !currentWorkspace.is_personal && (
          <button className="sidebar-footer-link" onClick={() => navigate('/team-settings')} style={{ color: 'var(--primary)', marginBottom: 8 }}>
